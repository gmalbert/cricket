...
COMPETITIONS = {
    ...
    "the_hundred": Competition("the_hundred", "The Hundred", "https://cricsheet.org/downloads/the_hundred_csv2.zip", "T20", 20, aliases=("Hundred",), odds_api_key="cricket_the_hundred", historical_dataset="the_hundred", season_window="2021-present", schedule_formats=("T20",)),
    "t20_blast": Competition("t20_blast", "T20 Blast", "https://cricsheet.org/downloads/t20_blast_csv2.zip", "T20", 20, aliases=("Vitality Blast",), odds_api_key="cricket_t20_blast", historical_dataset="t20_blast", season_window="2003-present", schedule_formats=("T20",)),
    ...
    "sa20": Competition("sa20", "SA20", "https://cricsheet.org/downloads/sa20_csv2.zip", "T20", 20, aliases=("SA 20",), historical_dataset="sa20", season_window="2023-present", schedule_formats=("T20",)),
