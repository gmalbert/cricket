...
def test_odds_match_aliases_and_marks_missing_draftkings():
    raw = [{
        "id": "event-1", "sport_key": "cricket_ipl",
        "home_team": "Royal Challengers Bengaluru", "away_team": "Delhi Capitals",
        "bookmakers": [{"key": "draftkings", "last_update": "2026-07-21T12:00:00Z", "markets": [{
            "key": "h2h", "outcomes": [
...
def test_international_t20_is_blocked_until_historical_gate_passes():
    ...
    status = competition_status(competition, fixtures=fixture, odds=odds,
...
def test_historical_coverage_reports_identity_rates():
    frame = pd.DataFrame([
        {"season": "2024", "match_id": "m1", "batting_team": "India", "bowling_team": "Australia", "striker": "A", "bowler": "B"},
        {"season": "2025", "match_id": "m2", "batting_team": "India", "bowling_team": "Australia", "striker": "A", "bowler": "B"},
    ])
...
def test_unready_competition_cannot_publish_h2h_bet():
    match = {
        "team1": "India", "team2": "Australia", "competition": "international_t20",
        "draftkings_available": True, "team1_win_prob": 0.70, "team2_win_prob": 0.30,
        "dk_implied_prob_team1": 0.50, "dk_implied_prob_team2": 0.50,
        "dk_odds_team1": -110, "dk_odds_team2": 100,
    }
...
def test_draftkings_event_becomes_provisional_fixture_when_schedule_is_missing():
    odds = [{
        ...
        "team1": "Zimbabwe", "team2": "India",
        "competition": "international_t20", "competition_name": "International T20",
        "event_status": "draftkings_available", "commence_time": "2026-07-23T11:00:00Z",
    }]
